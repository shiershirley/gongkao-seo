...
def main():
    ...
    articles = [
        {
            "title": "上海社区工作者备考时间规划：从零基础到高分上岸的详细方案",
            "description": "为零基础考生量身定制上海社区工作者备考时间规划方案，涵盖各阶段学习重点、时间分配及高效复习策略，助你科学备考、稳步上岸。",
            "category": "shanghai-shegong",
            "tags": ["上海社区工作者", "备考规划", "零基础", "时间管理", "上岸方案"],
            "keyword": "上海社区工作者备考规划",
            "filename": f"{today}-shanghai-shegong-beikao-shijian-guihua.md",
        },
        {
            ...
            "keyword": "上海社工报考条件",
            "filename": f"{today}-shanghai-shegong-baokao-tiaojian-2026.md",
        },
        {
            "title": "国考行测数量关系速解技巧：10种实用方法助你突破得分瓶颈",
            "description": "归纳国考行测数量关系模块最实用的10种速解方法，包含代入排除、数字特性、方程法等核心技巧，帮助考生摆脱数量关系恐惧心理。",
            "category": "guokao",
            "tags": ["国考", "行测", "数量关系", "速解技巧", "得分突破"],
            "keyword": "国考行测数量关系",
            "filename": f"{today}-guokao-xingce-shuliangguanxi-suojie.md",
        },
        {
            ...
            "keyword": "国考面试综合分析",
            "filename": f"{today}-guokao-mianshi-zonghe-fenxi.md",
        },
        {
            "title": "省考申论综合分析题解题技巧：从材料中精准提炼关键要点",
            "description": "系统讲解省考申论综合分析题的解题思路和技巧方法，重点教授如何从给定材料中精准提炼关键信息、构建逻辑清晰的答案框架。",
            "category": "shengkao",
            "tags": ["省考", "申论", "综合分析", "材料提炼", "解题技巧"],
            "keyword": "省考申论综合分析",
            "filename": f"{today}-shengkao-shenlun-zonghe-fenxi.md",
        },
        {
            "title": "省考行测言语理解与表达：高频题型解题思路与高效训练方法",
            "description": "聚焦省考行测言语理解与表达模块的高频题型，包括阅读理解、逻辑填空和语句排序，提供系统解题思路和针对性训练方法。",
            "category": "shengkao",
            "tags": ["省考", "行测", "言语理解", "高频题型", "训练方法"],
            "keyword": "省考行测言语理解",
            "filename": f"{today}-shengkao-xingce-yanyu-lijie.md",
        },
        {
            ...
            "keyword": "事业单位专业技术岗位",
            "filename": f"{today}-shiyedanwei-zhuanyejishu-gangwei.md",
        },
        {
            ...
            "keyword": "公考笔试时间分配",
            "filename": f"{today}-beikao-zhinan-bishi-shijian-fenpei.md",
        },
    ]
