...
### 执行概况
- **执行时间**：2026-05-07 12:01
- **生成文章数**：20篇
- **关键词覆盖**：上海社区工作者招聘2026、公务员考试公告2026、省考报名时间2026、国考职位表2026

### 生成文章列表

#### 上海社区工作者（6篇）
1. `content/shanghai-shegong/2026-05-07-pudong-shegong-zhaopin-506.md` - 浦东新区招聘506人公告解读
2. `content/shanghai-shegong/2026-05-07-shegong-baoming-quanliucheng.md` - 报名全流程指南
3. `content/shanghai-shegong/2026-05-07-yingjiesheng-shegong-kaifang.md` - 应届生全面开放政策
4. `content/shanghai-shegong/2026-05-07-shegong-xinzi-daoyu.md` - 薪资待遇详解
5. `content/shanghai-shegong/2026-05-07-pudong-zhaopin-xiangqing.md` - 浦东招聘职位详情
6. `content/shanghai-shegong/2026-05-07-shegong-yusni-yuanxing.md` - 社区工作者与网格员区别（实际生成在beikao-zhinan）

#### 国考相关（4篇）
1. `content/baokao-gonggao/2026-05-07-guokao-zhaoming-381wan.md` - 国考招录3.81万人公告
2. `content/baokao-gonggao/2026-05-07-guokao-bizhang-biaozhun.md` - 职位表下载与筛选
3. `content/baokao-gonggao/2026-05-07-guokao-nianling-fangkuan.md` - 年龄放宽政策解读
4. `content/baokao-gonggao/2026-05-07-guokao-bulu-mianshi-beikao.md` - 备考攻略

#### 省考相关（4篇）
1. `content/gangwei-fenxi/2026-05-07-shengkao-liankao-shijian.md` - 联考时间汇总
2. `content/shengkao/2026-05-07-shengkao-bumengtiaojian.md` - 报名条件全解析
3. `content/shengkao/2026-05-07-shengkao-xianchangbaoming.md` - 报名常见问题
4. `content/shengkao/2026-05-07-shengkao-jingpin-gangwei.md` - 精品岗位推荐

#### 社区工作者备考（5篇）
1. `content/zhengce-jiedu/2026-05-07-shegong-bankaozhengce.md` - 报名条件详细解读
2. `content/zhengce-jiedu/2026-05-07-shegong-yuanxuliesha.md` - 零基础备考指南
3. `content/guokao/2026-05-07-shegong-bisai-kaoshineirong.md` - 笔试内容与备考攻略
4. `content/guokao/2026-05-07-shegong-mianshi-jiqiao.md` - 面试技巧与常见题型
5. `content/guokao/2026-05-07-shegong-beikao-gonglue.md` - 从零基础到成功上岸

#### 真题解析（3篇）
1. `content/zhenti-jiexi/2026-05-07-guokao-xingce-jiexi.md` - 国考行测真题分析
2. `content/zhenti-jiexi/2026-05-07-shengkao-shenlun-jiexi.md` - 省考申论备考指南
3. `content/beikao-zhinan/2026-05-07-shegong-yusni.md` - 社区工作者与网格员对比

#### 扩展话题（1篇）
1. `content/baokao-gonggao/2026-05-07-guokao-bulu-mianshi-beikao.md` - 国考笔试面试备考
...
### 异常记录
- GitHub连接被重置（Connection was reset）
- 重试后仍然失败（Failed to connect to github.com port 443）
...
### 执行概况
- **执行时间**：2026-05-08 06:00（定时触发）
- **生成文章数**：6篇
- **关键词覆盖**：社区工作者考什么、社区工作者报考要求、社区工作者学历要求、社区工作者年龄限制、社区工作者复习计划、社工考试多久开始准备

### 生成文章列表

#### 社区工作者考试内容类（1篇）
1. `content/shanghai-shegong/2026-05-08-shegong-kaoshi-kaoshenme.md` - 社区工作者考什么（P1问题型）

#### 政策解读类（3篇）
1. `content/zhengce-jiedu/2026-05-08-shegong-baokao-yaoqiu.md` - 社区工作者报考要求（P1信息型）
2. `content/zhengce-jiedu/2026-05-08-shegong-xueli-yaoqiu.md` - 社区工作者学历要求（P1问题型）
3. `content/zhengce-jiedu/2026-05-08-shegong-nianling-xianzhi.md` - 社区工作者年龄限制（P1问题型）

#### 备考指南类（2篇）
1. `content/beikao-zhinan/2026-05-08-shegong-fuxi-jihua.md` - 社区工作者复习计划（P1指南型）
2. `content/beikao-zhinan/2026-05-08-shegong-kaoshi-duojiu-kaishi-zhunbei.md` - 社工考试多久开始准备（P1问题型）
...
### Git操作
- **提交**：`content: auto publish articles 2026-05-08`（commit: c95e6fc）
...
### 执行概况
- **执行时间**：2026-05-12 06:00（定时触发）
- **生成文章数**：4篇
- **关键词覆盖**：社区工作者招聘（P0）、上海社区工作者招聘（P0）、社区工作者待遇（P0）、社区工作者笔试考什么（P1）、社区工作者报名条件（P1）

### 生成文章列表

#### 上海社区工作者类（1篇）
1. `content/shanghai-shegong/2026-05-12-shanghai-shequgongzuozhe-zhaopin-zhinan.md` - 2026年上海社区工作者招聘全攻略（P0）

#### 政策解读类（2篇）
1. `content/zhengce-jiedu/2026-05-12-shequgongzuozhe-daiyu-quanjiexi.md` - 社区工作者待遇全解析（P0）
2. `content/zhengce-jiedu/2026-05-12-shegong-baoming-tiaojian-quanjiexi.md` - 社区工作者报名条件详解（P1）

#### 备考指南类（1篇）
1. `content/beikao-zhinan/2026-05-12-shegong-bishi-kaoshenme-zhinan.md` - 社区工作者笔试考什么（P1）
...
### Git操作
- **提交**：`content: auto publish articles 2026-05-12`（commit: 1e340f9）
- **推送状态**：✅ 成功推送至 origin/main
- **Vercel部署**：已触发自动部署
...
#### 上海社工考试类（1篇）
1. `content/shanghai-shegong/2026-05-13-shequgongzuozhe-kaoshi-quanjiexi.md` - 社区工作者考试全解析（P0）

#### 政策解读类（1篇）
1. `content/zhengce-jiedu/2026-05-13-shequgongzuozhe-baoming-quanliucheng.md` - 社区工作者报名全流程（P0）

#### 备考指南类（2篇）
1. `content/beikao-zhinan/2026-05-13-shequgongzuozhe-beikao-gonglue.md` - 社区工作者备考攻略（P1）
2. `content/beikao-zhinan/2026-05-13-shequgongzuozhe-mianshi-neirong-jiqiao.md` - 社区工作者面试内容与技巧（P1）
...
### Git操作
- **提交**：`content: auto publish articles 2026-05-13`（commit: de6e2e0）
- **推送状态**：✅ 成功推送至 origin/main
- **Vercel部署**：已触发自动部署
...
- **关键词覆盖**：上海社工考试真题、上海社工薪资待遇、国考备考攻略、国考报名指南、省考备考策略
...
### 配图情况
- ✅ 已为文章选取配图（通过image_picker.py）
- ✅ 图片路径格式正确：`/images/lib/[theme]/xxx.jpg`
- ⚠️ 需手动将选取的图片插入文章合适位置

### 校验结果
- **frontmatter_validator.py**：✅ 所有文件校验通过（使用--fix模式自动修复）
- **YAML格式**：✅ 无错误
...
### 注意事项
- 因token限制，本次只完成4篇文章（原计划8篇）
- 文章配图已选取但未完全插入（需后续完善）
- 建议后续执行时优化文章生成效率，确保完成8篇目标
- 关键词池需要添加更多未覆盖的关键词

### 下次改进
1. 优化文章生成模板，提高生成速度
2. 确保每篇文章都正确插入2张配图
3. 完成剩余的4篇文章（省考1篇+事业单位1篇+通用备考1篇+国考/社工类1篇）
4. 更新关键词池，标记已覆盖的关键词

---
*记录时间：2026-05-21 06:30*
